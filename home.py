...
sleep_time = st.slider("Tiempo de retraso (en segundos) entre la descarga del video y el audio:", min_value=0, max_value=60, value=5)
...
def download_video_audio(youtube_url, resolution):
    try:
        ...
        if video_stream and audio_stream:
            ...
            st.write(f"Esperando {sleep_time} segundos antes de descargar el audio...")
